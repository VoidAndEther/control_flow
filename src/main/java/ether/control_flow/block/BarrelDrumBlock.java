...
public class BarrelDrumBlock
    extends Block
    implements FluidDrainable, FluidFillable
{

    private static final BooleanProperty LAVALOGGED =
    ...
    private static final VoxelShape DOWN_SHAPE = VoxelShapes.union(
        Block.createCuboidShape(0.0F, 14.0F, 0.0F, 16.0F, 16.0F, 16.0F),
        Block.createCuboidShape(0.0F, 0.0F, 0.0F, 2.0F, 16.0F, 16.0F),
        Block.createCuboidShape(14.0F, 0.0F, 0.0F, 16.0F, 16.0F, 16.0F),
        Block.createCuboidShape(2.0F, 0.0F, 14.0F, 14.0F, 16.0F, 16.0F),
        Block.createCuboidShape(2.0F, 0.0F, 0.0F, 14.0F, 16.0F, 2.0F)
    );
    ...
    private static final VoxelShape WEST_SHAPE = VoxelShapes.union(
        ...
        Block.createCuboidShape(0.0F, 0.0F, 0.0F, 16.0F, 2.0F, 16.0F),
        Block.createCuboidShape(0.0F, 14.0F, 0.0F, 16.0F, 16.0F, 16.0F),
        Block.createCuboidShape(0.0F, 2.0F, 0.0F, 16.0F, 14.0F, 2.0F),
        Block.createCuboidShape(0.0F, 2.0F, 14.0F, 16.0F, 14.0F, 16.0F)
    );
    ...
    private static final VoxelShape NORTH_SHAPE = VoxelShapes.union(
        ...
        Block.createCuboidShape(0.0F, 0.0F, 0.0F, 16.0F, 2.0F, 16.0F),
        Block.createCuboidShape(0.0F, 14.0F, 0.0F, 16.0F, 16.0F, 16.0F),
        Block.createCuboidShape(14.0F, 2.0F, 0.0F, 16.0F, 14.0F, 16.0F),
        Block.createCuboidShape(0.0F, 2.0F, 0.0F, 2.0F, 14.0F, 16.0F)
    );
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return this.getDefaultState()
            ...
            .with(LAVALOGGED, fluidState.getFluid() == Fluids.LAVA);
    }
    ...
    public BlockState getStateForNeighborUpdate(
        ...
        Fluid fluid = state.get(WATERLOGGED)
            ? Fluids.WATER
    ...
    public FluidState getFluidState(BlockState state) {
        FlowableFluid fluid = state.get(WATERLOGGED)
            ? Fluids.WATER
            : state.get(LAVALOGGED)
                ? Fluids.LAVA
                : null;
        return fluid != null
            ? fluid.getStill(false)
